...
import cn.egret.server.service.*;
    ...
    public RespBean importEmployee(MultipartFile file) {
        ...
        try {
            ...
            list.forEach(employee -> {
                // 民族id  nations.indexOf(new Nation(employee.getNation().getName()))是获取该对象在列表里面的索引下标
                // @RequiredArgsConstructor注解让Nation对象生成构造函数，构造函数的参数是被final修饰的变量以及被@NonNull注解修饰的变量
                // 下同
